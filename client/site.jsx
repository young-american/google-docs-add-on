	...
	render() {
		...
		return <li>
			<div className="sites-list__basic">
				...
				<PostButton
					site={ site }
					onPostSave={ this.props.setPost }
					postTags={ this.state.postTags}
					postCategories={ this.state.postCategories }
					postType={ this.state.postType }
					errorHandler={ this.props.errorHandler }
					selectedPhotographerUrl={ this.props.selectedPhotographerUrl }
					selectedPhotographerName={ this.props.selectedPhotographerName }
					selectedPhotoDescription={ this.props.selectedPhotoDescription }
